...
import com.simplilearn.webservice.exceptions.InvalidUserException;
import com.simplilearn.webservice.exceptions.UserNotFoundException;
...
public class UserController {
	...
	// list all users
		...
		public User updateUser(@RequestBody User userObj) {
			...
			fetchedUser.setMobNum(userObj.getMobNum());
			fetchedUser.setEmail(userObj.getEmail());
			fetchedUser.setAddress(userObj.getAddress());
			fetchedUser.setSize(userObj.getSize());
